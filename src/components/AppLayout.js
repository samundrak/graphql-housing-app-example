  ...
  <div>
    <header className="header">
      <div className="container-lg">
        <Link to="/">
          <img src={imgUrl} alt="Homelike logo" />
        </Link>
